...
public class Board3 {
     ...
     */
    public boolean Place(Marker3 marker, int row, int column) {
        if (this.board[row][column] == Marker3.EMPTY) {
     ...
     */
    public boolean Winner(Marker3 marker) {
    ...
    public boolean Full() {
        ...
        for (int i=0;i<3;i++) {
            for (int j=0;j<3;j++) {
                if (this.board[i][j] == Marker3.EMPTY) {
                    emptyCount++;
                }                    
            }
        }
