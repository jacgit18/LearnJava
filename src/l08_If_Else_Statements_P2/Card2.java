...
public class Card2 {    
     ...
     */
    public boolean sameSuit(Card2 c) {
     ...
     */
    public boolean sameRank(Card2 c) {
     ...
     */
    public int rankDiff(Card2 c) {   
        return (this.rank - c.rank);
    }
    
    /**
     * Used to sort by suit then card rank (ala hearts, spades, pitch games)
     * @param c the card to compare to 
     * @return returns true when c less than this card
     */
    public boolean lessThanBySuitThenRank(Card2 c)
    {
        /* HINT:
     ...
     */
    public boolean lessThanByRankThenSuit(Card2 c)
    {
